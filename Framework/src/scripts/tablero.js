...
const miniRuletaImage = document.getElementById("mini-ruleta-image");

// Intentar cargar el icono guardado en localStorage
const savedIcon = localStorage.getItem("userIcon");

if (savedIcon) {
    // Si se encuentra un icono guardado en localStorage, actualizar el src
    miniRuletaImage.src = savedIcon;
} else {
