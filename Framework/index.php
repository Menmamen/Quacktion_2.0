...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['username']) && isset($_POST['password'])) {
        ...
        $pword = mysqli_fetch_assoc($result);

        if (isset($pword['passwordhash'])) {
            if ($pword['passwordhash'] === $password) {
                //$mensaje = "Bienvenido " . $username;
                //$msgClass = "success-message";
                $_SESSION['username'] = $username;
                header("Location: main.php"); //Dirijo a la otra página si se inicia sesion
            } else {
        ...
        $mensaje = "Debes introducir un nombre de usuario y contraseña.";
        $msgClass = "error-message";
    }
}
